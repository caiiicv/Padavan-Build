...
echo "修改登陆密码"
sed -i 's/DEF_ROOT_PASSWORD	"deng123"/DEF_ROOT_PASSWORD	"'$user_password'"/g' $default_file

echo "修改 LAN IP 地址"
sed -i "s/192.168.10/$lan_ip/g" $default_file

echo "修改 2G 无线名称"
sed -i 's/DEF_WLAN_2G_SSID	BOARD_PID "dem"/DEF_WLAN_2G_SSID	"'$wlan_2g_ssid'"/g' $default_file

echo "修改 5G 无线名称"
sed -i 's/DEF_WLAN_5G_SSID	BOARD_PID "dem"/DEF_WLAN_5G_SSID	"'$wlan_5g_ssid'"/g' $default_file
...
sed -i 's/DEF_WLAN_2G_PSK		"dem666666"/DEF_WLAN_2G_PSK		"'$wlan_2g_psk'"/g' $default_file

echo "修改 5GHz WIFI 密码"
sed -i 's/DEF_WLAN_5G_PSK		"dem666666"/DEF_WLAN_5G_PSK		"'$wlan_5g_psk'"/g' $default_file
